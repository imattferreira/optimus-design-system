...
export const { getCssText, globalCss, styled, theme, config } = createStitches({
  theme: {
    colors: {
      blue100: '#D7F0FE',
      blue200: '#AFDDFD',
  ...
  utils: {
    ...
    columns: (value: PropertyValue<'gridTemplateColumns'>) => ({ gridTemplateColumns: value }),
    ...
    rows: (value: PropertyValue<'gridTemplateRows'>) => ({ gridTemplateRows: value }),
